...
## [一本通原题](http://ybt.ssoier.cn:8088/problem_show.php?pid=1806)

事实上这题是**快速幂+扩展Lucus定理+扩展BSGS**的题。
事实上，只要做出这三道模板题就可以做出来了

#### [【模板】快速幂||取余运算](https://www.luogu.org/problem/P1226)
#### [【模板】exBSGS/Spoj3105 Mod](https://www.luogu.org/problem/P4195)
#### [【模板】扩展卢卡斯](https://www.luogu.org/problem/P4720)
```cpp
#include<cstdio>
#include<cctype>
#include<cmath>
